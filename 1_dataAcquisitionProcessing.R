...
setwd("/Users/uqtstapl/Library/CloudStorage/Dropbox/Tim/Post-doc/Research projects/novel_comms_legacy/")
...
large_file_path <- "/Users/uqtstapl/Library/CloudStorage/Dropbox/Tim/Post-doc/Large data files/novel_comms_plants"
...
package.loader(c("neotoma2", "taxize", "taxizedb", "sp", "maptools", "rworldmap", "vegan",
                 "divDyn", "DHARMa", "nlme", "lme4", "fossil", "multcomp", "WorldFlora"))
...
saveRDS(plantRecords, file=paste0(large_file_path,
                                   "/Neotoma vascular plant records.rds"))

plantRecords <- readRDS(paste0(large_file_path,
                                "/Neotoma vascular plant records.rds"))
...
WFO.remember(WFO.file = "./rawdata/wfoBackbone/classification.csv", WFO.data = "WFO.data", WFO.pos = 1)
...
write.csv(taxTable, "./outputs/WFOTaxaTable.csv")
